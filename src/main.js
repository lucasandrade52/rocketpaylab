...
const ccBgCollor01 = document.querySelector(
  ".cc-bg svg > g g:nth-child(1) path"
)
const ccBgCollor02 = document.querySelector(
...
function setCardType(type) {
  const colors = {
    ...
    americanExpress: ["#FFFFFF", "#016FD0"],
    discover: ["#FFFFFF", "#F78222"],
...
cardHolder.addEventListener("input", () => {
  ...
  ccHolder.innerText =
    cardHolder.value.length > 0 ? cardHolder.value : "NOME E SOBRENOME"
})
